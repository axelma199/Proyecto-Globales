import React, { Component } from 'react';
 ...
 getOrderById() {
 axios.get('http://localhost:3001/orders/editOrder/' + this.props.match.params.id)
 .then((response) => {
 this.setState({
id: response.data.id,
 ...
 f_entrega: response.data.f_entrega,
 ...
 axios.post('http://localhost:3001/orders/updateOrder/' + this.props.match.params.id, {
 id: id,
 cliente: cliente,
 articulo: articulo,
 cantidad: cantidad,
